...
\new Score <<
  \new ChoirStaff <<
    ...
    \relative c'' {
      ...
      d1~ | d2 e | a,2. b4 | \ap b8 c2. bf4 | a1\tr\sf |
      a | bf2. b4 | cs2\prallup d2~ | d\ce cs | d1\fe |
      ...
      r8 c f f \aap f4 e8 d4 | c8. c16 c4 c2 | c2 r2 |
      r2 r8 c f f | \ac f e4 e r f~ |
      f8 f f2 d4~ | d8 e16 f g4 c,2 |
      R1*2 |
      r4 r8 e f4 f8 d | \ac d c4 c r2 |
      r4 a a a8 c | \ac c bf4 bf bf4. bf8 | a4\ce a' a2\tr\sf | a2\fe
      ...
      r8 e8 f g | a f c'8. c16 c4 f, | \aap g a16 a4\prallup\sf \ap a8 bf2 \pa\m |
      r8 bf \ag a[( { bf32 a } g8)] a a \ag g8.[( { a64 g } f16)] | \ag e2\trr e8
      \ag a2 a16 | d,4 g4. e8 \ap e f4~ |
      f\> g \ap g8 a2 | <>\! | r2 \endPhrase \bar "!"

      r | R1*4 | r4 

      c,8. c16 c4 cs8.\tr d16 | d4 fs8. fs16 fs4 fs8. g16 |
      g4 f4. f8 e8.\tr f16 | f4\m f
      ...
      \who "violons"
      f8\mp e\tr \ag a { a32( g) } f8 g |
      e\tr a d, \aap g d c8. b16 b4\tr | a8. \br
      ...
      R1*2
      r8 a' \ac bf8 c4 g8. a16 bf4 | f8. g16 a4 g8 g bf4 | a2\tr\sf r
      ...
      r2 r4 r8 c\mp | \ac c8 d4 _\markup \italic "peu" \< e8 e f4 f |
      ...
      R1 | r8. a16\mf d8. e16 f8 f \ap f16 e8. d16 | cs8 cs( d e a,) a' g8.\tr f16 |
      e8 e( f g g a f g | a2 g\pa\tr |
      f8) e( f g a2~ | a4) g2 fs4 | g8 d ef4 d2 | g, r8 c d e | f a g8.\tr f16 e8 c e8. f16 |
      g4. g8 a4 a8. a16 | bf4 a2 g4 | a2 r |
      R1*6 |
      R1*4 | r8 f\f e8.\tr d16 c8 d \ap c16 bf4 | a2 r |
      R1 | r8 f'\mf e8.\tr d16 c4 r | r r8 c bf g c c | d4 c8\< bf \ap bf16 a4\f a |
      R1 | r2 r8 a a4 | a1\fe |
      ...
      d4. d8 d4 | d4. d8 d4 | c c4. f8 | d4 d c | bf g4.\tr a8 | a2 c4 |
      g'4. g8 g4 | e2 a,4 | d e4.\tr d8 | d2

      \phraseLabel "Symphonie"
      a'4~ | a4 g4. g8 | g4. a8 f4 | e e2\tr | d4.
      a8 b c | d2. | cs2\tr d4~ | d4 cs2\tr |
      \time 4/4
      d2\fe \endPhrase 
      ...
      r2 | R1*5 |
      d2.\f d4 | d1 | e | \ag a, { bf64( c d e f g } | a2.) g4( | f)\um e d2~ | d d |
      d1 \> <>\mp |

      R1 | d | c2. c4 | c2.\tr c4 | c2\fe\> c~\p | c e | d2.\tr d4 | d1 |
    ...
    \relative c'' {
      ...
      e4 d | c2\prallup d4 c | bf\tr a g c~\ce | c c\fe
      \ap { a32-> bf } c2\am~ | c e | d1 | cs2\prallup d4 e | \ap e16 f4 g a2\tr\sf |

      \ag bf1( c16) | a2.\tr\sf g4 | f1 | e1 | c1 |
      ...
      r4 f e8\prall f16 g a4 | f2\tr g4 g | e\ce d e2 | \ap e8 fs2\fe
      ...
      \who "violon seul"
      r2 r8 a,\p a8.\m b16 |
      \ap b c8 c b8.\tr d16 cs8\tr cs d8.\m e16 |
      \ac e8 f4 e\prallup f8 c d d |
      \aap e4 fs16 fs4\prallup \ap fs8 g2\m |
      r8 g \ag f[( {g32 f} e8)] f f \ag e8.[( { f64 e } d16)] |
      cs2\trr r8 d cs d |
      bf2\trr a4 a |
      \ap a8 d4 d2 cs4 | d2\m

      r2 | R1*4 | r4

      a'8 a a4\m \aap g { f32 e16 } |
      fs4\upprall a8. a16 \after 8 {
      ...
      R1*2
      r8 f \ac g a4 e8 e g4 | d8 d f4 e8. f16 g4 | a2\tr\sf
      r
      r4 r8 a bf4\m g8 g | a4\m a
      r2 | r2
      r8 a a4 | g8 g g4 f r | r8 g f8 d e2\tr |
      R1*3
      r4 r8 a f4 g8. g16 | \ac g8 a4 a8 a a4 a8. a16 | g4 fs r a~\mp |
      a8 g g f f4\tr e8 e | \ac e8 f4 _\markup \italic "peu" \< g8 g a4 a |
      ...
      R1*2 | r8 a\mf( g e f) f e8.\tr d16 | cs8 cs d d e f d e | f c f2 e4 |
      f8 c d e f f e\tr f | d4. c8 c2 | b4 c2 b4 |
      c8 c' bf8.\tr c16 a2 | r8 c bf8.\tr a16 g2 |
      r8 g, c4. b8 d4~ | d cs d2 | cs2\tr r | 
      R1*6 | R1*2 |
      r2 r8 e \ac d8 e8. f16 | g8 g f8.\tr e16 d8 d e4 | f8 f\f g4 a8 a g4 | e2\tr r2 |
      R1
      r2 r8 a\mf g8.\tr f16 | e4.\tr fs8 g4 f~ | f8 f\< f g a2\f |
      R1
      r4 g\ce f e\tr | fs1\fe\ca |
      ...
      fs4. fs8 fs4 | g4. g8 g4 | g a4. a8 | g4 a d, | g f4.\tr g8 | f2 a4 |
      g4. g8 d4 | \ac g8 a4-> e f | f e4.\tr fs8 | fs2
      \aap d4 c8 | b4. b8 e4 | cs2\tr d4 | d cs4.\tr d8 | d4
      a'2~ | a4 g8 fs g4~ | g f8 e f4~ | f8 e8 e2\tr |
      \time 4/4
      d2 \fe
      ...
      r2 a'2~ | a g4\prall f | e2\tr f | \after 4 \ce g2. g4 | f2~\fe\> f\am\p | g1 |
      a2 g~ | g4 f8\prall e f2~ | f4 f e\prall d | 
      f2\< e~ | e d~ | d\ce cs\ff | 
      ...
      r8 d\ff e fs g2~ | \cadenzaOn g4( fs\tr e \cadenzaOff fs\breve\upprall\fe)
  ...
  \relative c'' {
    ...
    a~ | a g | f4 d a' e | f g a2~ | a g2 | a1 | %r2 d | d2. % g,4~ | g f8 e f4 a | a1\ce | a \fe |
  }
